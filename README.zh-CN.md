...
YOUOWN 不把“识别饮食”锁死在某一个固定模型里。你选择什么 AI、你的账号支持什么能力，它就可以用什么作为输入：

- 直接用 ChatGPT 语音说，不用每顿饭都手写。
- 发一张饭菜照片、营养成分表、原材料表；如果你使用的 AI 和账号支持视频，也可以把短视频作为判断上下文。
- 告诉它餐厅名字和套餐名字；如果当前 AI 能联网搜索，就让它去查官网菜单或其他可靠来源。
- 在同一个对话里要求它修正、比较份量、解释误差，或者重新估算一次。

换句话说，市面上热量记录 App 里常见的那套 AI 工作流——拍照、看标签、查食物、估算份量、补充说明——大部分都可以交给你自己选择的 AI 来完成。ChatGPT 可以，其他 AI 也可以；你甚至可以按自己的习惯做定制，不需要被锁在某个 App 的内置模型里。

这个方式最省时间的地方，是你可以直接说话。输入信息足够清楚时，能力更强的模型通常也比健康 App 为了压成本而接入的低价识别模型更有发挥空间。但它仍然是估算：品牌、份量、菜谱、照片和餐厅菜单都可能带来误差，重要的记录还是要看一眼再确认。

YOUOWN 本身不收额外的 App 费用。如果你使用的是现有 ChatGPT 订阅里已经包含的能力，并且没有另外接入单独计费的 API、连接器、搜索服务或托管服务，那么这套日常记录流程可以只使用你已经支付的订阅。需要注意的是，ChatGPT 订阅和 OpenAI API 是分开计费的，具体语音、图片、视频、联网搜索和额度也取决于你的套餐与账号。可以参考 [ChatGPT Voice 官方说明](https://help.openai.com/en/articles/20001274) 和 [官方计费说明](https://help.openai.com/en/articles/9039756-managing-billing-for-chatgpt-and-the-api-platform)。
